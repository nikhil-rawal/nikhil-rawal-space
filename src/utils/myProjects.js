export const myProjects = [
  {
    ...
    images: [
      ...
      "https://images.pexels.com/photos/159045/the-interior-of-the-repair-interior-design-159045.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    ],
    description:
      "Virat Kohli is an Indian international cricketer who plays Test and ODI cricket for the Indian national team. A former captain in all formats of the game, Kohli retired from the T20I format following India's win at the 2024 T20 World Cup. He's a right-handed batsman and an occasional unorthodox right arm quick bowler.",
    tags: ["Kohli", "Virat", "Virat Kohli", "Anushka", "Virushka"],
    liveLink: "#",
    codeLink: "#",
  },
  {
    ...
    description:
      "Jasprit Jasbirsingh Bumrah is an Indian international cricketer who plays for the Indian cricket team in all formats of the game, and is currently the vice-captain of India in Test format. ",
    tags: ["Bumrah", "Jasprit", "Fast Bowler", "Captain"],
    liveLink: "#",
    codeLink: "#",
  },
];
