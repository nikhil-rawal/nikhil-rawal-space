...
const Header = () => {
  ...
  return (
    <div className="flex flex-row rounded-2xl shadow-sm isolate bg-background/10 saturate-100 backdrop-blur-[10px] transition-shadow fixed z-10 w-full md:w-10/12 lg:w-8/12">
