...
const Footer = () => {
  return (
    <div className="footer flex flex-col items-center mx-auto py-8 mb-4 mt-8 footer rounded-2xl shadow-2xl isolate bg-background/10 saturate-100 backdrop-blur-[10px] transition-shadow z-10 w-full md:w-10/12 lg:w-9/12">
      {/* Contact Section */}
